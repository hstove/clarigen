...
<skill>
<name>bv</name>
<description>`bv`, short for "beads viewer", is a tool for viewing beads (which are AI-native todos). `bv` provides helpers for AI agents to easily triage available tasks.</description>
