...
- [`set-burnchain-parameters`](#set-burnchain-parameters)
- [`disallow-contract-caller`](#disallow-contract-caller)
- [`allow-contract-caller`](#allow-contract-caller)
- [`stack-stx`](#stack-stx)
- [`revoke-delegate-stx`](#revoke-delegate-stx)
- [`delegate-stx`](#delegate-stx)
- [`stack-aggregation-commit`](#stack-aggregation-commit)
- [`stack-aggregation-commit-indexed`](#stack-aggregation-commit-indexed)
- [`stack-aggregation-increase`](#stack-aggregation-increase)
- [`delegate-stack-stx`](#delegate-stack-stx)
- [`stack-increase`](#stack-increase)
- [`stack-extend`](#stack-extend)
- [`delegate-stack-increase`](#delegate-stack-increase)
- [`delegate-stack-extend`](#delegate-stack-extend)
- [`set-signer-key-authorization`](#set-signer-key-authorization)

**Read-only functions:**

- [`burn-height-to-reward-cycle`](#burn-height-to-reward-cycle)
- [`reward-cycle-to-burn-height`](#reward-cycle-to-burn-height)
- [`current-pox-reward-cycle`](#current-pox-reward-cycle)
- [`get-stacker-info`](#get-stacker-info)
- [`check-caller-allowed`](#check-caller-allowed)
- [`get-check-delegation`](#get-check-delegation)
- [`get-reward-set-size`](#get-reward-set-size)
- [`get-total-ustx-stacked`](#get-total-ustx-stacked)
- [`get-reward-set-pox-address`](#get-reward-set-pox-address)
- [`get-stacking-minimum`](#get-stacking-minimum)
- [`check-pox-addr-version`](#check-pox-addr-version)
- [`check-pox-addr-hashbytes`](#check-pox-addr-hashbytes)
- [`check-pox-lock-period`](#check-pox-lock-period)
- [`can-stack-stx`](#can-stack-stx)
- [`minimal-can-stack-stx`](#minimal-can-stack-stx)
- [`get-signer-key-message-hash`](#get-signer-key-message-hash)
- [`verify-signer-key-sig`](#verify-signer-key-sig)
- [`get-pox-info`](#get-pox-info)
- [`get-delegation-info`](#get-delegation-info)
- [`get-allowance-contract-callers`](#get-allowance-contract-callers)
- [`get-num-reward-set-pox-addresses`](#get-num-reward-set-pox-addresses)
- [`get-partial-stacked-by-cycle`](#get-partial-stacked-by-cycle)

**Private functions:**

- [`append-reward-cycle-pox-addr`](#append-reward-cycle-pox-addr)
- [`add-pox-addr-to-ith-reward-cycle`](#add-pox-addr-to-ith-reward-cycle)
- [`add-pox-addr-to-reward-cycles`](#add-pox-addr-to-reward-cycles)
- [`add-pox-partial-stacked-to-ith-cycle`](#add-pox-partial-stacked-to-ith-cycle)
- [`add-pox-partial-stacked`](#add-pox-partial-stacked)
- [`consume-signer-key-authorization`](#consume-signer-key-authorization)
- [`inner-stack-aggregation-commit`](#inner-stack-aggregation-commit)
- [`increase-reward-cycle-entry`](#increase-reward-cycle-entry)

**Maps**

- [`stacking-state`](#stacking-state)
- [`delegation-state`](#delegation-state)
- [`allowance-contract-callers`](#allowance-contract-callers)
- [`reward-cycle-total-stacked`](#reward-cycle-total-stacked)
- [`reward-cycle-pox-address-list`](#reward-cycle-pox-address-list)
- [`reward-cycle-pox-address-list-len`](#reward-cycle-pox-address-list-len)
- [`partial-stacked-by-cycle`](#partial-stacked-by-cycle)
- [`logged-partial-stacked-by-cycle`](#logged-partial-stacked-by-cycle)
- [`signer-key-authorizations`](#signer-key-authorizations)
- [`used-signer-key-authorizations`](#used-signer-key-authorizations)

**Variables**

- [`pox-prepare-cycle-length`](#pox-prepare-cycle-length)
- [`pox-reward-cycle-length`](#pox-reward-cycle-length)
- [`first-burnchain-block-height`](#first-burnchain-block-height)
- [`configured`](#configured)
- [`first-pox-4-reward-cycle`](#first-pox-4-reward-cycle)

**Constants**

- [`ERR_STACKING_UNREACHABLE`](#err_stacking_unreachable)
- [`ERR_STACKING_CORRUPTED_STATE`](#err_stacking_corrupted_state)
- [`ERR_STACKING_INSUFFICIENT_FUNDS`](#err_stacking_insufficient_funds)
- [`ERR_STACKING_INVALID_LOCK_PERIOD`](#err_stacking_invalid_lock_period)
- [`ERR_STACKING_ALREADY_STACKED`](#err_stacking_already_stacked)
- [`ERR_STACKING_NO_SUCH_PRINCIPAL`](#err_stacking_no_such_principal)
- [`ERR_STACKING_EXPIRED`](#err_stacking_expired)
- [`ERR_STACKING_STX_LOCKED`](#err_stacking_stx_locked)
- [`ERR_STACKING_PERMISSION_DENIED`](#err_stacking_permission_denied)
- [`ERR_STACKING_THRESHOLD_NOT_MET`](#err_stacking_threshold_not_met)
- [`ERR_STACKING_POX_ADDRESS_IN_USE`](#err_stacking_pox_address_in_use)
- [`ERR_STACKING_INVALID_POX_ADDRESS`](#err_stacking_invalid_pox_address)
- [`ERR_STACKING_INVALID_AMOUNT`](#err_stacking_invalid_amount)
- [`ERR_NOT_ALLOWED`](#err_not_allowed)
- [`ERR_STACKING_ALREADY_DELEGATED`](#err_stacking_already_delegated)
- [`ERR_DELEGATION_EXPIRES_DURING_LOCK`](#err_delegation_expires_during_lock)
- [`ERR_DELEGATION_TOO_MUCH_LOCKED`](#err_delegation_too_much_locked)
- [`ERR_DELEGATION_POX_ADDR_REQUIRED`](#err_delegation_pox_addr_required)
- [`ERR_INVALID_START_BURN_HEIGHT`](#err_invalid_start_burn_height)
- [`ERR_NOT_CURRENT_STACKER`](#err_not_current_stacker)
- [`ERR_STACK_EXTEND_NOT_LOCKED`](#err_stack_extend_not_locked)
- [`ERR_STACK_INCREASE_NOT_LOCKED`](#err_stack_increase_not_locked)
- [`ERR_DELEGATION_NO_REWARD_SLOT`](#err_delegation_no_reward_slot)
- [`ERR_DELEGATION_WRONG_REWARD_SLOT`](#err_delegation_wrong_reward_slot)
- [`ERR_STACKING_IS_DELEGATED`](#err_stacking_is_delegated)
- [`ERR_STACKING_NOT_DELEGATED`](#err_stacking_not_delegated)
- [`ERR_INVALID_SIGNER_KEY`](#err_invalid_signer_key)
- [`ERR_REUSED_SIGNER_KEY`](#err_reused_signer_key)
- [`ERR_DELEGATION_ALREADY_REVOKED`](#err_delegation_already_revoked)
- [`ERR_INVALID_SIGNATURE_PUBKEY`](#err_invalid_signature_pubkey)
- [`ERR_INVALID_SIGNATURE_RECOVER`](#err_invalid_signature_recover)
- [`ERR_INVALID_REWARD_CYCLE`](#err_invalid_reward_cycle)
- [`ERR_SIGNER_AUTH_AMOUNT_TOO_HIGH`](#err_signer_auth_amount_too_high)
- [`ERR_SIGNER_AUTH_USED`](#err_signer_auth_used)
- [`ERR_INVALID_INCREASE`](#err_invalid_increase)
- [`ADDRESS_VERSION_P2PKH`](#address_version_p2pkh)
- [`ADDRESS_VERSION_P2SH`](#address_version_p2sh)
- [`ADDRESS_VERSION_P2WPKH`](#address_version_p2wpkh)
- [`ADDRESS_VERSION_P2WSH`](#address_version_p2wsh)
- [`ADDRESS_VERSION_NATIVE_P2WPKH`](#address_version_native_p2wpkh)
- [`ADDRESS_VERSION_NATIVE_P2WSH`](#address_version_native_p2wsh)
- [`ADDRESS_VERSION_NATIVE_P2TR`](#address_version_native_p2tr)
- [`STACKS_ADDR_VERSION_MAINNET`](#stacks_addr_version_mainnet)
- [`STACKS_ADDR_VERSION_TESTNET`](#stacks_addr_version_testnet)
- [`MAX_ADDRESS_VERSION`](#max_address_version)
- [`MAX_ADDRESS_VERSION_BUFF_20`](#max_address_version_buff_20)
- [`MAX_ADDRESS_VERSION_BUFF_32`](#max_address_version_buff_32)
- [`MIN_POX_REWARD_CYCLES`](#min_pox_reward_cycles)
- [`MAX_POX_REWARD_CYCLES`](#max_pox_reward_cycles)
- [`PREPARE_CYCLE_LENGTH`](#prepare_cycle_length)
- [`REWARD_CYCLE_LENGTH`](#reward_cycle_length)
- [`STACKING_THRESHOLD_25`](#stacking_threshold_25)
- [`SIP018_MSG_PREFIX`](#sip018_msg_prefix)

## Functions

### set-burnchain-parameters

`(define-public (set-burnchain-parameters ((first-burn-height uint) (prepare-cycle-length uint) (reward-cycle-length uint) (begin-pox-4-reward-cycle uint)) (response bool int))`
...
`(define-read-only (burn-height-to-reward-cycle ((height uint)) uint)`
...
`(define-read-only (reward-cycle-to-burn-height ((cycle uint)) uint)`
...
`(define-read-only (current-pox-reward-cycle () uint)`
...
`(define-read-only (get-stacker-info ((stacker principal)) (optional (tuple (delegated-to (optional principal)) (first-reward-cycle uint) (lock-period uint) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-set-indexes (list 12 uint)))))`
...
`(define-read-only (check-caller-allowed () bool)`
...
`(define-read-only (get-check-delegation ((stacker principal)) (optional (tuple (amount-ustx uint) (delegated-to principal) (pox-addr (optional (tuple (hashbytes (buff 32)) (version (buff 1))))) (until-burn-ht (optional uint)))))`
...
`(define-read-only (get-reward-set-size ((reward-cycle uint)) uint)`
...
`(define-private (append-reward-cycle-pox-addr ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint) (amount-ustx uint) (stacker (optional principal)) (signer (buff 33))) uint)`
...
| Name         | Type                                             | Description |
| ------------ | ------------------------------------------------ | ----------- |
| pox-addr     | (tuple (hashbytes (buff 32)) (version (buff 1))) |             |
| reward-cycle | uint                                             |             |
| amount-ustx  | uint                                             |             |
| stacker      | (optional principal)                             |             |
| signer       | (buff 33)                                        |             |
...
`(define-read-only (get-total-ustx-stacked ((reward-cycle uint)) uint)`
...
`(define-read-only (get-reward-set-pox-address ((reward-cycle uint) (index uint)) (optional (tuple (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (signer (buff 33)) (stacker (optional principal)) (total-ustx uint))))`
...
`(define-private (add-pox-addr-to-ith-reward-cycle ((cycle-index uint) (params (tuple (amount-ustx uint) (first-reward-cycle uint) (i uint) (num-cycles uint) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-set-indexes (list 12 uint)) (signer (buff 33)) (stacker (optional principal))))) (tuple (amount-ustx uint) (first-reward-cycle uint) (i uint) (num-cycles uint) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-set-indexes (list 12 uint)) (signer (buff 33)) (stacker (optional principal))))`
...
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| cycle-index | uint                                                                                                                                                                                                                              |             |
| params      | (tuple (amount-ustx uint) (first-reward-cycle uint) (i uint) (num-cycles uint) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-set-indexes (list 12 uint)) (signer (buff 33)) (stacker (optional principal))) |             |

### add-pox-addr-to-reward-cycles

`(define-private (add-pox-addr-to-reward-cycles ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (first-reward-cycle uint) (num-cycles uint) (amount-ustx uint) (stacker principal) (signer (buff 33))) (response (list 12 uint) int))`
...
### add-pox-partial-stacked-to-ith-cycle

`(define-private (add-pox-partial-stacked-to-ith-cycle ((cycle-index uint) (params (tuple (amount-ustx uint) (num-cycles uint) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint)))) (tuple (amount-ustx uint) (num-cycles uint) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint)))`
...
| ----------- | ---------------------------------------------------------------------------------------------------------------------------- | ----------- |
| cycle-index | uint                                                                                                                         |             |
| params      | (tuple (amount-ustx uint) (num-cycles uint) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint)) |             |

### add-pox-partial-stacked

`(define-private (add-pox-partial-stacked ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (first-reward-cycle uint) (num-cycles uint) (amount-ustx uint)) bool)`
...
`(define-read-only (get-stacking-minimum () uint)`
...
`(define-read-only (check-pox-addr-version ((version (buff 1))) bool)`
...
`(define-read-only (check-pox-addr-hashbytes ((version (buff 1)) (hashbytes (buff 32))) bool)`
...
`(define-read-only (check-pox-lock-period ((lock-period uint)) bool)`
...
`(define-read-only (can-stack-stx ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (amount-ustx uint) (first-reward-cycle uint) (num-cycles uint)) (response bool int))`
...
`(define-read-only (minimal-can-stack-stx ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (amount-ustx uint) (first-reward-cycle uint) (num-cycles uint)) (response bool int))`
...
`(define-public (disallow-contract-caller ((caller principal)) (response bool int))`
...
`(define-public (allow-contract-caller ((caller principal) (until-burn-ht (optional uint))) (response bool int))`
...
`(define-public (stack-stx ((amount-ustx uint) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (start-burn-ht uint) (lock-period uint) (signer-sig (optional (buff 65))) (signer-key (buff 33)) (max-amount uint) (auth-id uint)) (response (tuple (lock-amount uint) (signer-key (buff 33)) (stacker principal) (unlock-burn-height uint)) int))`
...
`(define-public (revoke-delegate-stx () (response (optional (tuple (amount-ustx uint) (delegated-to principal) (pox-addr (optional (tuple (hashbytes (buff 32)) (version (buff 1))))) (until-burn-ht (optional uint)))) int))`
...
`(define-public (delegate-stx ((amount-ustx uint) (delegate-to principal) (until-burn-ht (optional uint)) (pox-addr (optional (tuple (hashbytes (buff 32)) (version (buff 1)))))) (response bool int))`
...
- pox-addr: an optional address to which any rewards _must_ be sent
...
| delegate-to   | principal                                                   |             |
| until-burn-ht | (optional uint)                                             |             |
| pox-addr      | (optional (tuple (hashbytes (buff 32)) (version (buff 1)))) |             |

### get-signer-key-message-hash

`(define-read-only (get-signer-key-message-hash ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint) (topic (string-ascii 14)) (period uint) (max-amount uint) (auth-id uint)) (buff 32))`
...
`(define-read-only (verify-signer-key-sig ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint) (topic (string-ascii 14)) (period uint) (signer-sig-opt (optional (buff 65))) (signer-key (buff 33)) (amount uint) (max-amount uint) (auth-id uint)) (response bool int))`
...
`(define-private (consume-signer-key-authorization ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint) (topic (string-ascii 14)) (period uint) (signer-sig-opt (optional (buff 65))) (signer-key (buff 33)) (amount uint) (max-amount uint) (auth-id uint)) (response bool int))`
...
### inner-stack-aggregation-commit

`(define-private (inner-stack-aggregation-commit ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint) (signer-sig (optional (buff 65))) (signer-key (buff 33)) (max-amount uint) (auth-id uint)) (response uint int))`

Commit partially stacked STX and allocate a new PoX reward address slot.
This allows a stacker/delegate to lock fewer STX than the minimal threshold in multiple transactions,
so long as: 1. The pox-addr is the same. 2. This &quot;commit&quot; transaction is called _before_ the PoX anchor block.
...
`(define-public (stack-aggregation-commit ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint) (signer-sig (optional (buff 65))) (signer-key (buff 33)) (max-amount uint) (auth-id uint)) (response bool int))`
...
`(define-public (stack-aggregation-commit-indexed ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint) (signer-sig (optional (buff 65))) (signer-key (buff 33)) (max-amount uint) (auth-id uint)) (response uint int))`
...
`(define-public (stack-aggregation-increase ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint) (reward-cycle-index uint) (signer-sig (optional (buff 65))) (signer-key (buff 33)) (max-amount uint) (auth-id uint)) (response bool int))`
...
`(define-public (delegate-stack-stx ((stacker principal) (amount-ustx uint) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (start-burn-ht uint) (lock-period uint)) (response (tuple (lock-amount uint) (stacker principal) (unlock-burn-height uint)) int))`
...
`(define-read-only (get-pox-info () (response (tuple (first-burnchain-block-height uint) (min-amount-ustx uint) (prepare-cycle-length uint) (reward-cycle-id uint) (reward-cycle-length uint) (total-liquid-supply-ustx uint)) none))`
...
### increase-reward-cycle-entry

`(define-private (increase-reward-cycle-entry ((reward-cycle-index uint) (updates (optional (tuple (add-amount uint) (first-cycle uint) (reward-cycle uint) (signer-key (buff 33)) (stacker principal))))) (optional (tuple (add-amount uint) (first-cycle uint) (reward-cycle uint) (signer-key (buff 33)) (stacker principal))))`
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------- | ----------- |
| reward-cycle-index | uint                                                                                                                   |             |
| updates            | (optional (tuple (add-amount uint) (first-cycle uint) (reward-cycle uint) (signer-key (buff 33)) (stacker principal))) |             |

### stack-increase

`(define-public (stack-increase ((increase-by uint) (signer-sig (optional (buff 65))) (signer-key (buff 33)) (max-amount uint) (auth-id uint)) (response (tuple (stacker principal) (total-locked uint)) int))`
...
`(define-public (stack-extend ((extend-count uint) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (signer-sig (optional (buff 65))) (signer-key (buff 33)) (max-amount uint) (auth-id uint)) (response (tuple (stacker principal) (unlock-burn-height uint)) int))`
...
`(define-public (delegate-stack-increase ((stacker principal) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (increase-by uint)) (response (tuple (stacker principal) (total-locked uint)) int))`
...
`(define-public (delegate-stack-extend ((stacker principal) (pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (extend-count uint)) (response (tuple (stacker principal) (unlock-burn-height uint)) int))`
...
`(define-public (set-signer-key-authorization ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (period uint) (reward-cycle uint) (topic (string-ascii 14)) (signer-key (buff 33)) (allowed bool) (max-amount uint) (auth-id uint)) (response bool int))`
...
`(define-read-only (get-delegation-info ((stacker principal)) (optional (tuple (amount-ustx uint) (delegated-to principal) (pox-addr (optional (tuple (hashbytes (buff 32)) (version (buff 1))))) (until-burn-ht (optional uint)))))`
...
`(define-read-only (get-allowance-contract-callers ((sender principal) (calling-contract principal)) (optional (tuple (until-burn-ht (optional uint)))))`
...
`(define-read-only (get-num-reward-set-pox-addresses ((reward-cycle uint)) uint)`
...
`(define-read-only (get-partial-stacked-by-cycle ((pox-addr (tuple (hashbytes (buff 32)) (version (buff 1)))) (reward-cycle uint) (sender principal)) (optional (tuple (stacked-amount uint))))`
...
### logged-partial-stacked-by-cycle
