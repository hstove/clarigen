...
When using Clarigen, all of your function's arguments and results are strictly type. In this example, passing a non-integer to `increment` will result in a TypeScript error.
