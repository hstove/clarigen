...
- The dev server is almost always running on `localhost:2527`.
- You can use the playwriter tool when you need to debug the app.
  - If you're debugging the tx builder, try this route for a good complex example: http://localhost:2527/tx/testnet/ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.tester/complex-args
  - A good "simple" example: http://localhost:2527/tx/mainnet/SP3K8BC0PPEVCV7NZ6QSRWPQ2JE9E5B6N3PA0KBR9.token-abtc/transfer
